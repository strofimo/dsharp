...
{
    public class LegacyCompilerStrategy : ICompilerStrategy
    {
        ...
        public void Compile(CompilerOptions options, IErrorHandler errorHandler)
        {
            ...
            this.errorHandler = errorHandler ?? throw new ArgumentNullException(nameof(options));
        ...
        private void BuildCodeModel()
        {
            ...
            codeModelBuilder = new MonoCodeModelBuilder(options, errorHandler);
        ...
        private void BuildMetadata()
        {
            ...
            MetadataBuilder mdBuilder = new MetadataBuilder(errorHandler);
